...
public class ConvertFileNameToModelProcessor implements Processor {
	private static final Logger log = LoggerFactory.getLogger(ConvertFileNameToModelProcessor.class);
